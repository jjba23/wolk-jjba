...
alias fr="cd ~/Ontwikkeling/Persoonlijk/wolk-jjba && make fr"
alias sr="cd ~/Ontwikkeling/Persoonlijk/wolk-jjba && make sr"
alias jr="cd ~/Ontwikkeling/Persoonlijk/wolk-jjba && make jr"
